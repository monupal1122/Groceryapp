...
const SignupScreen = ({ navigation }) => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (!result.success) {
        Alert.alert("Signup Failed", result.error || "Failed to create account", [{ text: "OK" }]);
      } else {
        Alert.alert(
          "Success",
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.headerSection}>
            ...
            <Text style={styles.subtitle}>Sign up to get started with Blinkit</Text>
          </View>
          ...
          <View style={styles.formSection}>
            ...
            <View style={[
              ...
              <View style={styles.iconWrapper}>
                <Icon name="person-outline" size={22} color={focusedField === 'username' ? "#10B981" : "#9CA3AF"} />
              </View>
              <TextInput
                style={styles.input}
